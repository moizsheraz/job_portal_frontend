...
export default function Footer() {
  return (
    <footer className="bg-[#042859] text-white px-6">
      <div className="container-custom py-10 md:py-14" style={{ paddingBottom: '1rem' }}>
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              ...
              <li><Link href="/legal#our-rules" className="hover:underline hover:text-white">Our Rules</Link></li>
              <li><Link href="/legal#transparency" className="hover:underline hover:text-white">Transparency & Responsibilities</Link></li>
            </ul>
          </div>
        </div>

        {/* Copyright */}
        <div className="border-t border-gray-700 pt-6 mt-10 text-sm text-gray-400 text-center" style={{ paddingTop: '1rem' }}>
