        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex space-x-4 mt-4">
              <a href="https://wa.me/233551992919" className="text-gray-400  hover:text-white transition-colors" target="_blank" rel="noopener noreferrer">
                <svg xmlns="http://www.w3.org/2000/svg" fill="#FFFFFF" height="20px" width="20px" version="1.1" id="Layer_1" viewBox="0 0 308 308">
                  <g id="XMLID_468_">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              ...
              <li><Link href="/contact" className="hover:underline hover:text-white">Guides</Link></li>
              <li><Link href="/contact" className="hover:underline hover:text-white">Events</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-400">
  <li><Link href="/legal#privacy-policy" className="hover:underline hover:text-white">Privacy Policy</Link></li>
  <li><Link href="/legal#terms-of-service" className="hover:underline hover:text-white">Terms of Service</Link></li>
  <li><Link href="/legal#cookie-policy" className="hover:underline hover:text-white">Cookie Policy</Link></li>
  <li><Link href="/legal#security" className="hover:underline hover:text-white">Security</Link></li>
</ul>
          </div>
        </div>
      </div>
